...
namespace Square.Common.HttpFunction
{
    public class HttpFunction
    {
        ...
        public async Task<StandardResponse> PetitionStandard(StandardRequest standard)
        {
            try
            {
                ...
                standard.TypeAuthorize = standard.IsIntegral ? "Bearer" : standard.TypeAuthorize;
                standard.TypeBody = standard.IsIntegral ? "json" : standard.TypeBody;
                ...
                //Si es primavera se obtienen los datos
                if (standard.IsPrimavera)
                {
                    //Este validación aplica cuando se usa el Login de Primavera
